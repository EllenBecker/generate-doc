...
let GenerateController = class GenerateController {
    ...
    generate() {
        return this.generateService.report();
    }
};
__decorate([
    (0, common_1.Post)(),
...
GenerateController = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof generate_service_1.GenerateService !== "undefined" && generate_service_1.GenerateService) === "function" ? _a : Object])
], GenerateController);
